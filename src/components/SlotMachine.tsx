...
const SlotMachine: React.FC = () => {
  ...
  const [showMainMenu, setShowMainMenu] = useState(() => {
    const saved = localStorage.getItem('mainMenuVisible');
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
      ...
      <div className={`relative flex flex-col items-center justify-center min-h-screen p-2 sm:p-4 transition-colors ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        >
          <div className="flex justify-between items-center p-2 gap-2 max-w-3xl mx-auto">
